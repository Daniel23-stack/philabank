					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="user_account" id="user_account" value="{{ old('user_account') }}" required>
							</div>
						</div>
...
(function ($) {
  ...
  $(document).on('blur','#user_account', function(){
	  	var accountNumber = $(this).val();

		if(accountNumber != ''){
			$.ajax({
				url: _url + '/transfer/get_account_name/' + accountNumber,
				beforeSend: function(){
