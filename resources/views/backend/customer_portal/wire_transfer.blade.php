		...
		<div class="card">
			...
			<div class="card-body">
			    <form method="post" class="validate" autocomplete="off" action="{{ route('transfer.wire_transfer') }}" enctype="multipart/form-data">
					{{ csrf_field() }}
					<div class="row">
						@if(get_option('bank_selection_method','selectbox') == 'selectbox')
						<div class="col-md-12">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="bank_name" name="td[bank_name]" value="{{ old('td.bank_name') }}" required>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control select2 auto-select" name="td[country]" data-selected="{{ old('td.country') }}" required>
									<option value="">{{ _lang('Select One') }}</option>
									{{ get_country_list() }}
								</select>
							</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">{{ _lang('Swift Code') }}</label>
								<input type="text" class="form-control" id="swift_code" name="td[swift_code]" value="{{ old('td.swift_code') }}" required>
							</div>
						</div>
						@endif
						...
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">{{ _lang('Currency') }}</label>
								<select class="form-control select2 auto-select" name="td[currency]" data-selected="{{ old('td.currency') }}" required>
									<option value="">{{ _lang('Select One') }}</option>
